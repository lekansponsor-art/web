...
Refer to the API reference in our docs to learn how [`findUniqueOrThrow`](https://www.prisma.io/docs/orm/v7/reference/prisma-client/model-queries#finduniqueorthrow) and [`findFirstOrThrow`](https://www.prisma.io/docs/orm/v7/reference/prisma-client/model-queries#findfirstorthrow) differ from `findUnique` and `findFirst` respectively.
...
Refer to the [`findUniqueOrThrow`](https://www.prisma.io/docs/orm/v7/reference/prisma-client/model-queries#finduniqueorthrow) and [`findFirstOrThrow`](https://www.prisma.io/docs/orm/v7/reference/prisma-client/model-queries#findfirstorthrow) docs to learn how you can upgrade.
