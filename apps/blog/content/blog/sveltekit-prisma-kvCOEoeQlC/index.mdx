...
1. Queries all published posts, including their authors, using the [`include` option](https://www.prisma.io/docs/orm/v7/reference/prisma-client/model-query-options#include).
...
1. Leverages the load function [`data` prop](https://www.prisma.io/docs/orm/v7/reference/prisma-client/model-query-options#include) to get the post `id`.
