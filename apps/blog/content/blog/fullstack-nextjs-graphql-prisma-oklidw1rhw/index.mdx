...
```
We are first creating a user using the [`create()`](https://www.prisma.io/docs/orm/v7/reference/prisma-client/model-queries#create) function, which creates a new database record.

Next, we are using the [`createMany()`](https://www.prisma.io/docs/orm/v7/reference/prisma-client/model-queries#createmany) function to create multiple records. We are passing the hard-coded data we have as a parameter.
