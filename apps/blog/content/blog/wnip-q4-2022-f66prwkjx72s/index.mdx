...
[Prisma’s `upsert`](https://www.prisma.io/docs/orm/v7/reference/prisma-client/model-queries#upsert) is one of its most powerful and most convenient APIs. Prisma will now default to the native database upsert for PostgreSQL, SQLite, and CockroachDB whenever possible.
