...
Use the `PrismaClient` [`log`](/orm/v7/reference/prisma-client/prisma-client-constructor#log) parameter to configure [log levels](/orm/v7/reference/prisma-client/prisma-client-constructor#log-levels) , including warnings, errors, and information about the queries sent to the database.
...
The exact [event (`e`) type and the properties available](/orm/v7/reference/prisma-client/prisma-client-constructor#event-types) depends on the log level.
