...
- Use nested reads ([`include`](/orm/v7/reference/prisma-client/model-query-options#include) ) to return users and related posts
- Use the [`in`](/orm/v7/reference/prisma-client/filter-conditions-and-operators#in) filter
