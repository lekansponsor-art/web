...
Case sensitivity depends on your database provider and collation settings. For PostgreSQL, Prisma Client also supports specific case-insensitive filter modes on supported operators. See the [Prisma Client API reference](/orm/v7/reference/prisma-client/filter-conditions-and-operators#mode) for details.
...
- [Prisma Client API reference](/orm/v7/reference/prisma-client/filter-conditions-and-operators)
