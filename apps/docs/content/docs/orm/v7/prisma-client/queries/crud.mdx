...
The following query uses [`delete()`](/orm/v7/reference/prisma-client/model-queries#delete) to delete a single `User` record:
...
The following query uses [`deleteMany()`](/orm/v7/reference/prisma-client/model-queries#deletemany) to delete all `User` records where `email` contains `prisma.io`:
...
The following query uses [`deleteMany()`](/orm/v7/reference/prisma-client/model-queries#deletemany) to delete all `User` records:
...
When you know the order in which your tables should be deleted, you can use the [`deleteMany`](/orm/v7/reference/prisma-client/model-queries#deletemany) function. This is executed synchronously in a [`$transaction`](/orm/v7/prisma-client/queries/transactions) and can be used with all types of databases.
