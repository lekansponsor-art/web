...
This example shows how an `undefined` parameter impacts the results returned by a query that uses the [`OR`](/orm/v7/reference/prisma-client/filter-conditions-and-operators#or) operator.
...
This is in contrast to the [`AND`](/orm/v7/reference/prisma-client/filter-conditions-and-operators#and) and [`NOT`](/orm/v7/reference/prisma-client-reference) operators, which will both return all the users
