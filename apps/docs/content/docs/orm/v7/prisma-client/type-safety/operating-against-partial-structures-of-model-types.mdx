...
When doing [`select`](/orm/v7/reference/prisma-client/model-query-options#select) or [`include`](/orm/v7/reference/prisma-client/model-query-options#include) operations on your models and returning these variants from a function, it can be difficult to gain access to the return type, e.g:
