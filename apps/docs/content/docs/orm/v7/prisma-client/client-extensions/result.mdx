...
You can use the [`omit` (Preview) option](/orm/v7/reference/prisma-client/model-query-options#omit) with [custom fields](#add-a-custom-field-to-query-results) and fields needed by custom fields.
